---
{"dg-publish":true,"dg-path":"00 - Sistema/Ações/Ações, Reações e Ações Livres.md","permalink":"/00 - Sistema/Ações/Ações, Reações e Ações Livres/","tags":["mecânica","aylar"],"created":"2026-01-13T11:32:15.581+00:00","updated":"2026-01-17T03:32:01.841+00:00"}
---
...
<span style="color:rgb(255, 99, 39)">Ações</span> e <span style="color:rgb(255, 99, 39)"><span style="color:rgb(163, 126, 196)">Reações</span></span> realizadas durante um combate (ou outro momento à base de turnos) são baseadas em <span style="color:rgb(255, 99, 39)">Action Points</span> 🟠 e <span style="color:rgb(163, 126, 196)">Reaction Points</span> 🟪. Cada personagem possui uma certa quantidade de 🟠 e 🟪, restaurados automaticamente no início do seu turno. 🟠 servem única e exclusivamente para realizar ações durante o turno de um personagem, enquanto que 🟪 servem apenas para realizar ações fora do mesmo. 

A tabela de <span style="color:rgb(255, 99, 39)">Action Points</span> e <span style="color:rgb(163, 126, 196)">Reaction Points</span> ganhos por nível e por classe está disponível em: https://docs.google.com/spreadsheets/d/135td4z67mIF97yf017IjGqWDp2RunHq9Ak-WN8X0kVI/edit?usp=sharing
...
<span style="color:rgb(255, 99, 39)">Ações</span> específicas de cada personagem, como spells ou ataques, têm o seu custo visível à frente do nome da <span style="color:rgb(255, 99, 39)">Ação</span> na ficha do personagem (ex: `Cloud of Daggers 🟠🟠` é um spell com um custo de  <span style="color:rgb(255, 99, 39)">2 Action Points</span>). Note-se que 🟠 e 🟪 não substituem os outros custos potencialmente associados a uma <span style="color:rgb(255, 99, 39)">Ação</span> (Spell Slots, componentes, etc...). As restantes <span style="color:rgb(255, 99, 39)">Ações</span> e <span style="color:rgb(163, 126, 196)">Reações</span> genéricas, que todos os personagens podem realizar, ficam aqui sumarizadas:
## <span style="color:rgb(255, 99, 39)">Ações</span>
### Ataques Desarmados:
**Custo:** 🟠
**Acerto:** Garantido
**Dano:** 1d4 + STR
...
**Custo:** 🟠 por cada 30ft
### Pulo:
**Custo:** 🟠 (adicionado ao movimento)
### Fugir:
**Custo:** 🟠
**Efeito:** Permite que o personagem se afaste da área imediata de um inimigo sem ativar um Oportunity Attack
### Equipar itens:
**Custo:** 🟠
### Usar Consumíveis:
**Custo:** 🟠

## <span style="color:rgb(163, 126, 196)">Reações</span>
### Esquiva:
**Custo:** 🟪🟪
